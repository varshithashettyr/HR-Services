...
const baseKeyServices: KeyService[] = [
  {
    name: "HR Recruitment and Onboarding",
    href: "https://www.brickworkindia.com/hr-services/hr-recruitment-and-onboarding",
    color: LOGO_COLORS.green,
    icon: UserPlus,
    subServices: [
      ["Recruitment Services", Users],
      ["Document Verification", FileCheck],
      ["Interview Scheduling", CalendarCheck],
      ["Co-ordination & Document Management", FolderOpen],
      ["Onboarding & Training", GraduationCap],
    ].map(([name, icon]) => ({
      name: name as string,
      href: "https://www.brickworkindia.com/hr-services/hr-recruitment-and-onboarding",
...

  {
    ...
    href: "https://www.brickworkindia.com/hr-services/hr-payroll-management",
    color: LOGO_COLORS.green,
    icon: WalletCards,
    subServices: [
      ["Employee Database Management", Database],
      ["Compensation and Benefits", BadgeDollarSign],
      ["Payroll Support", Calculator],
  ...
  {
    name: "Learning and Competency Development",
    href: "https://www.brickworkindia.com/hr-services/learning-and-competency-development",
    color: LOGO_COLORS.green,
    icon: GraduationCap,
    subServices: [
      ["Scheduling Training Sessions", CalendarCheck],
      ["Coordinating with Trainers and Participants", Users],
      ["Managing Virtual and In-Person Training Logistics", Monitor],
      ["User Administration and Enrollment", UserPlus],
      ["Tracking Learner Progress and Completion", ChartNoAxesCombined],
      ["Generating Training Reports and Analytics", FileBarChart],
    ].map(([name, icon]) => ({
      name: name as string,
      href: "https://www.brickworkindia.com/hr-services/learning-and-competency-development",
      icon: icon as ElementType,
